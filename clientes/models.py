...
class Animal(models.Model):#animal
    ...
    tutor = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name= '+')

    # telefone = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name= 'telefone')
    # email = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name= 'email')
    # data_criacaotutor = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name= 'data_criacaotutor')
    # descricaotutor = models.ForeignKey(Tutor, on_delete=models.CASCADE, related_name= 'descricaotutor')
